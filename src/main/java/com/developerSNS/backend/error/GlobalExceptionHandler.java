...
import static com.developerSNS.backend.error.ErrorCode.INPUT_INVALID_VALUE;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
        ...
        log.warn(e.getMessage());
        return ResponseEntity.status(INPUT_INVALID_VALUE.getHttpStatus()).body(response);
    }
}
